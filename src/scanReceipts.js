...
const scanReceipt = async (image) => {
	try {
		...
		let data = "urls=http://www.printablesample.com/wp-content/uploads/2017/03/Short-Grocery-Receipt-Format-3.jpg";

		const res = await fetch("https://app.nanonets.com/api/v2/OCR/Model/4616eef1-9ee9-4a4b-beba-88eba6135f89/LabelUrls/", {
			"method": "post",
